...
def _parse_mibs(iLOIP, auth_user, auth_protocol=None, auth_prot_pp=None,
                priv_protocol=None, auth_priv_pp=None):
    """Parses the MIBs.
...
def _get_disksize_MiB(iLOIP, auth_user, auth_protocol=None, auth_prot_pp=None,
                      priv_protocol=None, auth_priv_pp=None):
    ...
    auth_Prot = _get_mapped_snmp_value('authProtocol', auth_protocol)
    priv_Prot = _get_mapped_snmp_value('privProtocol', priv_protocol)
...
def get_local_gb(iLOIP, auth_user, auth_protocol=None, auth_prot_pp=None,
                 priv_protocol=None, auth_priv_pp=None):
    ...
    :param auth_priv_pp: Pass phrase value for Privacy Protocol.
    """
    disk_sizes = _get_disksize_MiB(iLOIP, auth_user,
