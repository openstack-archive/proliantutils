...
class IloClient(operations.IloOperations):
    ...
    def get_essential_properties(self, authUser=None, authProtValue=None, privProtValue=None,
                                 authProtocol=None, privProtocol=None, snmp_inspection=False):
        ...
        if (data['properties']['local_gb'] == 0):
            if snmp_inspection:
                disksize = snmp_cpqdisk_sizes.get_local_gb(self.host, authUser,
                                                           authProtValue, privProtValue,
