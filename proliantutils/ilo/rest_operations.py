...
from proliantutils.ilo import rest
...
class IloRestOperations(operations.IloOperations, rest.RestClientBase):

    def __init__(self, host, username, password,
                 default_prefix='/rest/v1/', sessionkey=None,
                 biospassword=None, cacert=None):
        super(IloRestOperations, self).__init__(
            host, username, password, default_prefix=default_prefix,
            sessionkey=sessionkey, biospassword=biospassword, cacert=cacert)
    ...
    def reset_ilo_credential(self, password):
        ...
        :raises: IloCommandNotSupportedError, if the command is not supported
                 on the server.
        """
        acc_uri = '/AccountService/Accounts'
