...
class RISOperations(operations.IloOperations):
    ...
    def get_server_capabilities(self):
        ...
        gpu_count_dict = self._get_vendor_gpu_count()
        capabilities.update(
            {'pci_gpu_devices': gpu_count_dict['pci_gpu_devices']})
        capabilities.update(gpu_count_dict['count'])
        try:
    ...
    def _get_vendor_gpu_count(self):
        ...
        return {'pci_gpu_devices': gpu_devices_count, 'count': count}
