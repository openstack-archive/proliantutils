...
class RISOperations(operations.IloOperations):
    ...
    def _validate_iscsi_patch(self):
        """Validates if patch is supported for iscsi.
    ...
    def _change_iscsi_settings(self, mac, iscsi_info):
        ...
        iscsi_uri, settings = self._validate_iscsi_patch()
