...
class RISOperations(rest.RestConnectorBase, operations.IloOperations):
    ...
    def get_current_bios_settings(self, apply_filter=True):
        ...
        :param apply_filter: True if only predefined BIOS settings
    ...
    def set_bios_settings(self, data=None, apply_filter=True):
        ...
        :param apply_filter: True if only predefined BIOS settings
                             are allowed. False otherwise.
        :param data: a dictionary of required BIOS settings to be applied.
        """
        if apply_filter and data:
