...
class RISOperations(operations.IloOperations):
    ...
    def _get_drive_type_and_speed(self):
        ...
        :returns: A dictionary with the following keys:
            - drive_rotational: True/False. It is True if atleast one
            rotational disk is attached.
            - drive_ssd: True/False. It is True if atleast one SSD disk is
            attached.
            - max_rotational_drive_rpm: The maximum RPM of the system's
            rotational disks or None if the system has no rotational
            disks attached.
        ...
        if logical_drive_details:
            for item in logical_drive_details:
                for key, value in item.items():
                    if key == 'Raid':
                        raid_level_var = "logical_raid_level_" + value
    ...
    def get_server_capabilities(self):
        ...
        raid_levels = self._get_logical_raid_levels()
        for item in raid_levels:
