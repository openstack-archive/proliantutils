...
class RISOperations(operations.IloOperations):
    ...
    def _update_persistent_boot(self, device_type=[], mac=None,
                                persistent=False):
    ...
    def update_persistent_boot(self, device_type=[], mac=None):
        ...
        self._update_persistent_boot(device_type, mac, persistent=True)
    ...
    def set_one_time_boot(self, device, mac=None):
        ...
        :raises: IloCommandNotSupportedError, if the command is not supported
                 on the server.
        """
        self._update_persistent_boot([device], mac, persistent=False)
