...
class RISOperations(operations.IloOperations):
    ...
    def _get_persistent_boot_order(self):
        ...
        try:
            boot_devices = boot_settings['PersistentBootConfigOrder']
        except KeyError:
    ...
    def get_persistent_boot_device(self):
        ...
        try:
            if system['Boot']['BootSourceOverrideEnabled'] == 'Continuous':
                return device_map[system['Boot']['BootSourceOverrideTarget']]
        ...
        boot_devices = self._get_persistent_boot_order()
    ...
    def _update_persistent_boot(self, device_type=[], persistent=False):
        ...
        if device_type[0].upper() in device_conversion:
