...
class FirmwareImageProcessor(object):
    ...
    def extract(self):
        ...
        :raises: IloConnectionError, if connection fails with iLO
    ...
    def upload_file_to(self, addressinfo, timeout):
        ...
        Uploads the raw firmware file (already set as attribute
        of FirmwareImageProcessor instance) to iLO
        :param addressinfo: hostname and port tuple
...
def _get_firmware_file_in_new_path(searching_path):
    ...
    fd, new_firmware_file_path = tempfile.mkstemp()
    # The first element of the tuple returned by mkstemp is typically
    # an integer used to refer to a file by the OS. It requires closing
    # of the file descriptor using os.close(). For details refer:
