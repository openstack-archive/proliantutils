...
class IloSNMPInvalidInputFailure(ProliantUtilsException):
    msg = "Failed to do SNMP retreival %(reason)s"
...
class IloSNMPExceptionFailure(ProliantUtilsException):
    msg = "SNMP library failed %(reason)s"
