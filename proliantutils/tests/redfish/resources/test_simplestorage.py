...
class SimpleStorageTestCase(testtools.TestCase):
    ...
    def setUp(self):
        ...
        self.sys_simple = simplestorage.SimpleStorage(
    ...
    def test__parse_attributes(self):
        ...
        self.assertEqual('Enabled', self.sys_simple.status.state)
        self.assertEqual('OK', self.sys_simple.status.health)
        devices = [{
            "Name": "SATA Bay 1",
        ...
        self.assertEqual(devices, self.sys_simple.devices)
...
class SimpleStorageCollectionTestCase(testtools.TestCase):
    ...
    def setUp(self):
        ...
        with open('proliantutils/tests/redfish/json_samples/'
                  'simplestorage_collection.json', 'r') as f:
            self.conn.get.return_value.json.return_value = json.loads(f.read())
        self.sys_simple_col = simplestorage.SimpleStorageCollection(
    ...
    @mock.patch.object(simplestorage, 'SimpleStorage', autospec=True)
