...
class HPEUpdateServiceTestCase(testtools.TestCase):
    ...
    def test_get_fw_update_uri_action_missing_uri(self):
        self.us_inst.get_fw_update_uri = None
        self.assertRaisesRegex(
            exception.MissingAttributeError,
            '/redfish/v1/UpdateService/Actions/UpdateService.SimpleUpdate/'
            'uri is missing',
            self.us_inst.get_fw_update_uri)

    def test_get_fw_update_uri_action_validate_uri(self):
        firmware_update_uri = ('/redfish/v1/UpdateService/Actions/'
                               'UpdateService.SimpleUpdate/')
        test_uri = self.us_inst.get_fw_update_uri()
        self.assertEqual(test_uri, firmware_update_uri)
