...
class HPESystemTestCase(testtools.TestCase):
    ...
    def test__get_subresource_path_by_name(self):
        value = self.sys_inst._get_subresource_path_by_name('SecureBoot')
        self.assertEqual('/redfish/v1/Systems/1/SecureBoot/', value)
    ...
    def test__get_secure_boot_path_missing_attr(self):
        ...
        self.assertRaisesRegex(
            ...
            self.sys_inst._get_subresource_path_by_name, 'SecureBoot')
