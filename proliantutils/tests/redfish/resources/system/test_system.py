...
class HPESystemTestCase(testtools.TestCase):
    ...
    @mock.patch.object(system.HPESystem, '_get_controller_model_by_ssc_id')
    ...
    @mock.patch.object(array_controller.HPEArrayControllerCollection,
                       'get_members')
    def test__get_controller_model_by_ssc_id(self, get_members_mock):
        ssc_id = '/redfish/v1/systems/1/smartstorageconfig'
        with open('proliantutils/tests/redfish/'
        ...
        expected = 'HPE Smart Array P408i-p SR Gen10'
        self.assertEqual(
            expected, self.sys_inst._get_controller_model_by_ssc_id(ssc_id))
