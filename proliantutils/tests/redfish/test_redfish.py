...
class RedfishOperationsTestCase(testtools.TestCase):
    ...
    def test_do_disk_erase_ssd_pattern_zero(self, get_system_mock):
        self.rf_client.do_disk_erase('HPE Smart Array P408i-a SR Gen10', 'SSD',
                                     'zero')
        get_system_mock.return_value.do_disk_erase.assert_called_once_with(
            'HPE Smart Array P408i-a SR Gen10', 'SSD', 'zero')
    ...
    def test_get_smart_storage_controllers(self, get_system_mock):
        expected = {'HPE Smart Array P408i-p SR Gen10': {'HDD': True,
                                                         'SDD': False}}
        (get_system_mock.return_value.
         get_smart_storage_controllers.return_value) = expected
        self.assertEqual(expected,
                         self.rf_client.get_smart_storage_controllers())
