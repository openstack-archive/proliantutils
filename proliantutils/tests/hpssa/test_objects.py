...
class ServerTest(testtools.TestCase):
    ...
    def test_server_object_one_logical_drive(self, get_all_details_mock):
        ...
        controller = server.controllers[0]
        self.assertEqual(5, len(controller.physical_drives))
        self.assertEqual(1, len(controller.arrays))

        # Assertion on arrays
        array = controller.arrays[0]
    ...
    def test_get_logical_drives(self, get_all_details_mock):
        ...
        exp_ld = server.controllers[0].arrays[0].logical_drives[0]
