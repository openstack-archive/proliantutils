...
class ManagerTestCases(testtools.TestCase):
    ...
    def test__filter_by_controllers_hba(self, get_all_details_mock):
        ...
        msg = ("An error was encountered while doing hpssa configuration: "
               "None of the available HPSSA controllers Smart Array P822 in "
               "Slot 3 have Raid enabled.")
        ex = self.assertRaises(exception.HPSSAOperationError,
                               manager._filter_by_controllers,
                               server, filter_condition, 'Raid enabled')
        self.assertIn(msg, str(ex))

    def test__filter_by_controllers(self, get_all_details_mock):
        get_all_details_mock.return_value = raid_constants.HPSSA_NO_DRIVES
        ...
        manager._filter_by_controllers(server, filter_condition,
                                       'Raid enabled')
    ...
    def test_erase_devices_no_drives(self, controller_exec_cmd_mock,
        ...
        expt_ret = ("None of the available HPSSA controllers Smart "
