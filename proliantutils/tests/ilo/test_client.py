...
class IloClientSNMPValidateTestCase(testtools.TestCase):
    ...
    def create_obj(self, product_mock):
        super(IloClientSNMPValidateTestCase, self).setUp()
        cred = {'auth_user': 'user',
                'auth_protocol': 'SHA',
                'priv_protocol': 'AES',
                'auth_prot_pp': '1234',
    ...
    @mock.patch.object(ribcl.RIBCLOperations, 'get_product_name')
    def create_obj_fail_auth_priv_pp_missing(self, product_mock):
        super(IloClientSNMPValidateTestCase, self).setUp()
        cred = {'auth_user': 'user',
                'auth_protocol': 'SHA',
                'priv_protocol': 'AES',
    ...
    @mock.patch.object(ribcl.RIBCLOperations, 'get_product_name')
    def create_obj_auth_prot_pp_missing(self, product_mock):
        super(IloClientSNMPValidateTestCase, self).setUp()
        cred = {'auth_user': 'user',
                'auth_protocol': 'SHA',
                'priv_protocol': 'AES',
    ...
    @mock.patch.object(ribcl.RIBCLOperations, 'get_product_name')
    def create_obj_auth_prot_priv_prot_missing(self, product_mock):
        super(IloClientSNMPValidateTestCase, self).setUp()
        cred = {'auth_user': 'user',
                'auth_prot_pp': '1234',
                'auth_priv_pp': '4321',
    ...
    @mock.patch.object(ribcl.RIBCLOperations, 'get_product_name')
    def create_obj_auth_user_missing(self, product_mock):
        super(IloClientSNMPValidateTestCase, self).setUp()
