...
class IloRisTestCase(unittest.TestCase):
    ...
    @mock.patch.object(ris.RISOperations, 'check_uefi_support')
    def test_get_http_boot_url(self, check_uefi_support_mock,
    ...
    @mock.patch.object(ris.RISOperations, 'check_uefi_support')
    def test_set_http_boot_url(self, check_uefi_support_mock,
    ...
    def test_check_uefi_support(self, get_current_boot_mode_mock):
