...
class IloRisTestCase(unittest.TestCase):
    ...
    @mock.patch.object(ris.RISOperations, 'is_cur_boot_mode_uefi')
    def test_get_http_boot_url(self, is_cur_boot_mode_uefi_mock,
        ...
        is_cur_boot_mode_uefi_mock.assert_called_once_with()
        self.assertEqual(
    ...
    @mock.patch.object(ris.RISOperations, 'is_cur_boot_mode_uefi')
    def test_set_http_boot_url(self, is_cur_boot_mode_uefi_mock,
    ...
    def test_is_cur_boot_mode_bios(self, get_current_boot_mode_mock):
        get_current_boot_mode_mock.return_value = 'LEGACY'
        self.assertRaises(exception.IloCommandNotSupportedError,
                          self.ilo.is_cur_boot_mode_uefi)

    @mock.patch.object(ris.RISOperations, 'get_current_boot_mode')
    def test_is_cur_boot_mode_uefi(self, get_current_boot_mode_mock):
        get_current_boot_mode_mock.return_value = 'UEFI'
        result = self.ilo.is_cur_boot_mode_uefi()
