...
class TestRISOperationsPrivateMethods(testtools.TestCase):
    ...
    def test__rest_op_okay(self, http_con_mock):
        ...
        http_con_mock.assert_called_once_with(host='1.2.3.4', strict=True)
    ...
    @mock.patch.object(httplib, 'HTTPSConnection')
    def test__rest_op_request_error(self, http_con_mock):
        connection_mock_obj = mock.MagicMock()
        http_con_mock.return_value = connection_mock_obj
    ...
    @mock.patch.object(httplib, 'HTTPSConnection')
    def test__rest_op_get_response_error(self, http_con_mock):
        connection_mock_obj = mock.MagicMock()
        http_con_mock.return_value = connection_mock_obj
    ...
    @mock.patch.object(httplib, 'HTTPSConnection')
    def test__rest_op_response_read_error(self, http_con_mock):
        connection_mock_obj = mock.MagicMock()
        response_mock_obj = mock.MagicMock(status=200)
        http_con_mock.return_value = connection_mock_obj
        connection_mock_obj.getresponse.return_value = response_mock_obj
    ...
    @mock.patch.object(httplib, 'HTTPSConnection')
    def test__rest_op_continous_redirection(self, http_con_mock):
        connection_mock_obj = mock.MagicMock()
    ...
    @mock.patch.object(httplib, 'HTTPSConnection')
    def test__rest_op_one_redirection(self, http_con_mock):
        connection_mock_obj = mock.MagicMock()
        ...
        http_con_mock.assert_any_call(host='1.2.3.4', strict=True)
        http_con_mock.assert_any_call(host='5.6.7.8', strict=True)

    @mock.patch.object(httplib, 'HTTPSConnection')
    def test__rest_op_response_decode_error(self, http_con_mock):
        connection_mock_obj = mock.MagicMock()
        response_mock_obj = mock.MagicMock(status=200)
        http_con_mock.return_value = connection_mock_obj
        connection_mock_obj.getresponse.return_value = response_mock_obj
    ...
    @mock.patch.object(httplib, 'HTTPSConnection')
    def test__rest_op_response_gzipped_resonse(self, http_con_mock):
        connection_mock_obj = mock.MagicMock()
        response_mock_obj = mock.MagicMock(status=200)
        http_con_mock.return_value = connection_mock_obj
        connection_mock_obj.getresponse.return_value = response_mock_obj
