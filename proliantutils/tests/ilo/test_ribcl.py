...
class IloRibclTestCase(unittest.TestCase):
    ...
    @mock.patch.object(
        ribcl.common.FirmwareImageProcessor, 'upload_file_to')
    ...
    def test_update_firmware(self, _parse_output_mock, _request_ilo_mock,
        ...
        # WHEN
        # -----------------------------------------------------------------------
        self.ilo.update_firmware('raw_fw_file.bin')
        # -----------------------------------------------------------------------
        # THEN
        # -----------------------------------------------------------------------
        ...
        root_xml_string = constants.UPDATE_FIRMWARE_INPUT_XML % (
