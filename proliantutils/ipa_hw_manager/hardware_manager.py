...
class ProliantHardwareManager(hardware.GenericHardwareManager):
    ...
    def hpsum_firmware_update(self, node, port):
        """Performs HPSUM firmware update on the bare metal node.

        This method performs firmware update on all or some of the
        firmware components on the bare metal node.
