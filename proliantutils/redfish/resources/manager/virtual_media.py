...
class VirtualMediaCollection(base.ResourceCollectionBase):
    ...
    def __init__(self, connector, path, redfish_version=None):
        """A class representing a VirtualMediaCollection

        :param connector: A Connector instance
        :param path: The canonical path to the VirtualMedia collection resource
        :param redfish_version: The version of RedFish. Used to construct
            the object according to schema of the given version.
        """
        super(VirtualMediaCollection, self).__init__(connector, path,
                                                     redfish_version)
