...
class BIOSSettings(base.ResourceBase):
    ...
    @property
    @utils.lazy_load_and_cache('_pending_settings')
    ...
    @property
    @utils.lazy_load_and_cache('_boot_settings')
    ...
    @property
    @utils.lazy_load_and_cache('_iscsi_settings')
    ...
    @utils.lazy_load_and_cache('_base_configs')
