...
from proliantutils.redfish.resources.system.storage import constants as storage_constant
...
class HPESystem(system.System):
    ...
    def smart_storage_controllers(self):
        ...
        try:
            ...
            for model in models:
                ...
                disk_status = {
                    disk_status[storage_constant.MEDIA_TYPE_HDD]: controller_obj.physical_drives.has_hdd,
                    disk_status[storage_constant.MEDIA_TYPE_SSD]: controller_obj.physical_drives.has_ssd
                    }
    ...
    def do_disk_erase(self, controller, disk_type):
        ...
        try:
            ...
            if disk_type == storage_constant.MEDIA_TYPE_HDD:
                hdds = controller_obj.physical_drives.get_all_hdd_drives()
                ssc_obj.disk_erase(hdds, storage_constant.MEDIA_TYPE_HDD)
            else:
                ssds = controller_obj.physical_drives.get_all_ssd_drives()
                ssc_obj.disk_erase(ssds, storage_constant.MEDIA_TYPE_SSD)
        except sushy.exceptions.SushyError as e:
    ...
    def disk_erase_status(self):
        ...
        try:
            ...
            parsed_controllers = filter(lambda x: x.split('Array ')[1][0] != 'S', controllers)
            for controller in parsed_controllers:
                controller_obj = self.smart_storage.array_controllers.array_controller_by_model(controller)
