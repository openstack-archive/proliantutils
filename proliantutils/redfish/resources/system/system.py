...
class HPESystem(system.System):
    ...
    @property
    @utils.lazy_load_and_cache_resource('_bios_settings')
    ...
    @property
    @utils.lazy_load_and_cache_resource('_pci_devices')
    ...
    @property
    @utils.lazy_load_and_cache_resource('_secure_boot')
    ...
    @property
    @utils.lazy_load_and_cache_resource('_ethernet_interfaces')
    ...
    @property
    @utils.lazy_load_and_cache_resource('_smart_storage')
    ...
    @property
    @utils.lazy_load_and_cache_resource('_storages')
    def storages(self):
    ...
    @property
    @utils.lazy_load_and_cache_resource('_simple_storages')
    ...
    @property
    @utils.lazy_load_and_cache_resource('_memory')
    def memory(self):
