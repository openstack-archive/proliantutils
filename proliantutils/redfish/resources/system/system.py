    ...
    def smart_storage_controllers(self):
        ...
        try:
            ...
            for model in models:
                ...
                disk_status = {
                    storage_constant.MEDIA_TYPE_HDD: controller_obj.physical_drives.has_hdd,
                    storage_constant.MEDIA_TYPE_SSD: controller_obj.physical_drives.has_ssd
                    }
